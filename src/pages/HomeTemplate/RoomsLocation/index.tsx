...
const RoomListingApp = () => {
  ...
  const citiesData = [{ id: 1, tenThanhPho: "Hồ Chí Minh" }];
      ...
      <div className="flex flex-col h-full">
        ...
        <CardContent className="flex-1 p-4 flex flex-col">
          ...
          <div className="mb-3">
            ...
            <p className="text-sm text-gray-600 line-clamp-1">{room.moTa}</p>
          </div>
          ...
          <div className="mt-4 flex items-center justify-between pt-4 border-t border-gray-200">
            <span className="text-xs text-gray-500">
              {getAmenitiesCount(room)} tiện nghi
            </span>
  ...
  const AmenityBadge = ({ icon: Icon, label }) => (
    <Badge
      variant="secondary"
      className="bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs gap-1"
    >
